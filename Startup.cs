...
namespace Markers_GPS_Coordiantes
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<MarkersContext>(options => options.UseSqlServer(Configuration.GetConnectionString("Myconnection")));
        ...
        public void Configure(IApplicationBuilder app, I env)
        {
