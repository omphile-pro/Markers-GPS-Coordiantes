...
namespace Markers_GPS_Coordiantes.Controllers
{
    ...
    [HttpPost]
        public IActionResult Create(TrueView model)
        {
            ...
            application.Langauge = model.Langauge;
            application.Paper = model.Paper;
            application.LiteraturePaper = model.LiteraturePaper;
            ...
            application.PrescribedBook = model.PrescribedBook;
            ...
            declerationByApplicant.Year = model.Year;
